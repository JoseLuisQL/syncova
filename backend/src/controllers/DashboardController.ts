...
export class DashboardController {
  ...
  static async getAlertasRecientes(req: Request, res: Response): Promise<void> {
    try {
      console.info('🚨 Obteniendo alertas recientes');

      const result = await DashboardService.getAlertasRecientes();
  ...
  static async getActividadReciente(req: Request, res: Response): Promise<void> {
    try {
      console.info('📋 Obteniendo actividad reciente del sistema');
