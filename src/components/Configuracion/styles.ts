export const CONFIG_STYLES = {
  ...
  subtleBadge: 'inline-flex items-center rounded-md border border-[#e7e7ef] bg-white px-2.5 py-1 text-[10px] font-medium uppercase tracking-[0.08em] text-[#606571]',
  input:
    'w-full rounded-lg border border-[#e7e7ef] bg-white px-4 py-2.5 text-sm text-[#15171d] shadow-sm transition placeholder:text-[#8b8f9b] hover:border-[#d7d8e2] focus:border-[#babdca] focus:outline-none focus:ring-2 focus:ring-[#dedfea]/70',
  buttonSecondary:
