      ...
      <div className="relative" ref={menuRef}>
        ...
        >
          ...
          <div className="hidden md:block text-left max-w-[140px] pl-1">
            <p className="text-[13px] font-bold text-gray-900 truncate leading-none mb-1">
              {displayName}
            </p>
            <p className="text-[10px] font-semibold text-gray-500 truncate leading-none uppercase tracking-wide">
              {formatRole(user.rol)}
            </p>
          </div>
