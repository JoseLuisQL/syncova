export const MODAL_STYLES = {
  button: {
    primary:
      'inline-flex h-9 items-center justify-center gap-2 rounded-[7px] bg-[#7c3aed] px-3.5 text-base font-semibold text-white shadow-none transition hover:bg-[#6d28d9] focus:outline-none focus:ring-2 focus:ring-[#7c3aed]/20 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60',
    secondary:
      'inline-flex h-9 items-center justify-center gap-2 rounded-[7px] border border-[#e7e7ef] bg-white px-3.5 text-base font-semibold text-[#15171d] shadow-none transition hover:border-[#d7d8e2] hover:bg-[#fbfafd] focus:outline-none focus:ring-2 focus:ring-[#dedfea]/70 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60',
    ghost:
      'inline-flex h-9 items-center justify-center gap-2 rounded-[7px] border border-[#e7e7ef] bg-white px-3 text-base font-semibold text-[#606571] transition hover:border-[#d7d8e2] hover:bg-[#fbfafd] hover:text-[#15171d] focus:outline-none focus:ring-2 focus:ring-[#dedfea]/70 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60',
  },

  input: {
    base:
      'min-h-9 w-full rounded-[7px] border border-[#e7e7ef] bg-white px-3 py-2 text-base text-[#15171d] shadow-none transition placeholder:text-[#a0a4ae] focus:outline-none focus:ring-2 disabled:bg-[#fbfafd] disabled:opacity-60',
    ...
    helpText: 'mt-1 text-xs leading-4 text-[#747986]',
  },
  ...
  modal: {
    ...
    panel:
      'relative w-full overflow-hidden rounded-t-[10px] border border-[#e7e7ef] bg-white shadow-[0_22px_54px_-38px_rgba(12,15,24,0.55)] sm:max-h-[88vh] sm:rounded-lg',
