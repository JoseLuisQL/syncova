export const MODAL_STYLES = {
  button: {
    ...
    secondary:
      'inline-flex h-9 items-center justify-center gap-2 rounded-[7px] border border-line bg-surface px-3.5 text-base font-semibold text-ink shadow-none transition hover:border-line-strong hover:bg-surface-soft focus:outline-none focus:ring-2 focus:ring-brand/20 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60',
    ghost:
      'inline-flex h-9 items-center justify-center gap-2 rounded-[7px] border border-line bg-surface px-3 text-base font-semibold text-muted-2 transition hover:border-line-strong hover:bg-surface-soft hover:text-ink focus:outline-none focus:ring-2 focus:ring-brand/20 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60',
  },

  input: {
    base:
      'min-h-9 w-full rounded-[7px] border border-line bg-surface px-3 py-2 text-base text-ink shadow-none transition placeholder:text-muted focus:outline-none focus:ring-2 disabled:bg-surface-soft disabled:opacity-60',
  ...
  modal: {
    ...
    panel:
      'relative w-full overflow-hidden rounded-t-[10px] border border-line bg-surface shadow-[0_22px_54px_-38px_rgba(12,15,24,0.55)] sm:max-h-[88vh] sm:rounded-lg',
    ...
    sideSheetPanel:
      'relative mt-auto flex h-[88vh] w-full flex-col border-l border-line bg-surface shadow-[0_22px_54px_-38px_rgba(12,15,24,0.55)] sm:mt-0 sm:h-full sm:max-w-xl',
  },
} as const;
