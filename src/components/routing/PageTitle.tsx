...
const getMetaDescription = (module: string, subModule?: string | null): string => {
  const descriptions: Record<string, string> = {
    ...
    'ici-demid': 'Importación y seguimiento del consolidado ICI DEMID por establecimiento y vacuna',
  ...
  if (subModule) {
    const subDescriptions: Record<string, string> = {
      ...
      'configuracion-jeringas': 'Asignación de jeringas por vacuna y centro de acopio',
...
const getMetaKeywords = (module: string, subModule?: string | null): string => {
  ...
  const moduleKeywords: Record<string, string> = {
    ...
    'ici-demid': 'ici demid, importación excel, establecimientos, vacunas',
  ...
  if (subModule) {
    const subKeywords: Record<string, string> = {
      ...
      'configuracion-jeringas': 'asignacion jeringas vacunas',
