...
export const STATS_CONFIG = {
  lotes: {
    vacunas: [
      ...
      { key: 'disponibles', label: 'Disponibles', icon: CheckCircle2, color: 'success' as const },
      { key: 'porVencer', label: 'Por Vencer', icon: ShieldAlert, color: 'warning' as const },
      { key: 'vencidos', label: 'Vencidos', icon: ShieldAlert, color: 'danger' as const },
    ],
    jeringas: [
      { key: 'total', label: 'Total Lotes', icon: Archive, color: 'primary' as const },
      { key: 'disponibles', label: 'Disponibles', icon: CheckCircle2, color: 'success' as const },
      { key: 'agotados', label: 'Agotados', icon: ShieldAlert, color: 'neutral' as const },
      { key: 'stockTotal', label: 'Stock Total', icon: TrendingUp, color: 'secondary' as const },
    ],
  },
  catalogos: {
    vacunas: [
      { key: 'total', label: 'Total Vacunas', icon: Package2, color: 'primary' as const },
      { key: 'activas', label: 'Activas', icon: CheckCircle2, color: 'success' as const },
      { key: 'conStock', label: 'Con Stock', icon: TrendingUp, color: 'secondary' as const },
      { key: 'sinStock', label: 'Sin Stock', icon: ShieldAlert, color: 'warning' as const },
    ],
    jeringas: [
