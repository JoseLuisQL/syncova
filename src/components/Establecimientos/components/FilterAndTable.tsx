        ...
        <div className="flex min-w-0 flex-1 flex-wrap items-center gap-2">
          ...
          {filters.length > 0 ? (
            <details className="group relative">
              ...
              <div className="absolute left-0 top-11 z-30 w-[min(280px,calc(100vw-3rem))] rounded-xl border border-line bg-white p-3 shadow-[0_18px_40px_-28px_rgba(12,15,24,0.45)]">
