...
// Paleta de colores unificada basada en Dashboard/Login (teal/cyan)
export const COLORS = {
  primary: {
...
// Configuracion de secciones del modulo
export const SECTIONS_CONFIG = [
  ...
  },
  {
    ...
    description: 'Puntos de distribucion',
    icon: Building2,
  ...
  },
  {
    ...
    description: 'Centros de atencion',
    icon: Building,
...
export const COMPONENT_STYLES = {
  ...
  nav: {
    tab: `flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium
...
// Configuracion de estadisticas por tipo de seccion
export const STATS_CONFIG = {
  redes: [
    { key: 'total', label: 'Total Redes', icon: Network, color: 'primary' },
    { key: 'activas', label: 'Activas', icon: Activity, color: 'success' },
    { key: 'conMicroredes', label: 'Con Microredes', icon: GitBranch, color: 'warning' },
    { key: 'inactivas', label: 'Inactivas', icon: Shield, color: 'danger' },
  ],
  microredes: [
    { key: 'total', label: 'Total Microredes', icon: GitBranch, color: 'primary' },
    { key: 'activas', label: 'Activas', icon: Activity, color: 'success' },
    { key: 'conCentros', label: 'Con Centros', icon: Building, color: 'warning' },
    { key: 'inactivas', label: 'Inactivas', icon: Shield, color: 'danger' },
  ],
  centrosAcopio: [
    { key: 'total', label: 'Total Centros', icon: Building2, color: 'primary' },
    { key: 'activos', label: 'Activos', icon: Activity, color: 'success' },
    { key: 'conEstablecimientos', label: 'Con Establecimientos', icon: Users, color: 'warning' },
    { key: 'inactivos', label: 'Inactivos', icon: Shield, color: 'danger' },
  ],
  establecimientos: [
    { key: 'centrosSalud', label: 'Centros de Salud', icon: Building, color: 'primary' },
    { key: 'puestosSalud', label: 'Puestos de Salud', icon: MapPin, color: 'secondary' },
    { key: 'hospitales', label: 'Hospitales', icon: Activity, color: 'warning' },
    { key: 'activos', label: 'Activos', icon: Users, color: 'success' },
  ],
} as const;

// Tipos de establecimiento con configuracion visual
