...
// Paleta de colores unificada con Inventario (teal/cyan)
export const COLORS = {
  primary: {
...
export const COMPONENT_STYLES = {
  ...
  modal: {
    ...
    containerFullscreen: 'bg-white rounded-xl w-[98vw] max-w-none max-h-[98vh] overflow-hidden shadow-2xl',
...
export const TABLA_COLUMNAS = [
  { key: 'establecimiento', label: 'Establecimiento', align: 'left' as const, width: 'w-64' },
  { key: 'saldoAnterior', label: 'Saldo Anterior', align: 'center' as const, width: 'w-28' },
  { key: 'transIngreso', label: 'Trans. Ingreso', align: 'center' as const, width: 'w-28', editable: true },
  { key: 'totalSaldo', label: 'Total Saldo', align: 'center' as const, width: 'w-28' },
  { key: 'salida', label: 'Salida', align: 'center' as const, width: 'w-28', editable: true },
  { key: 'transSalida', label: 'Trans. Salida', align: 'center' as const, width: 'w-28', editable: true },
  { key: 'saldo', label: 'Saldo', align: 'center' as const, width: 'w-28' },
  { key: 'entrega', label: 'Entrega', align: 'center' as const, width: 'w-40', editable: true },
  { key: 'stock', label: 'Stock', align: 'center' as const, width: 'w-28' },
  { key: 'promedioConsumo', label: 'Promedio', align: 'center' as const, width: 'w-28' },
  { key: 'disponibilidad', label: 'Disponibilidad', align: 'center' as const, width: 'w-32' },
  { key: 'acciones', label: 'Acciones', align: 'center' as const, width: 'w-32' },
] as const;

// Estilos para inputs editables por tipo de campo
export const INPUT_FIELD_STYLES = {
  ...
  salida: {
    normal: 'border-cyan-300 bg-cyan-50 hover:bg-cyan-100 hover:border-cyan-400',
    focus: 'focus:ring-cyan-300 focus:border-cyan-500',
    pending: 'border-amber-400 bg-amber-50 shadow-md ring-2 ring-amber-200',
  },
  transSalida: {
    normal: 'border-teal-300 bg-teal-50 hover:bg-teal-100 hover:border-teal-400',
  ...
  entrega: {
    normal: 'border-emerald-300 bg-emerald-50 hover:bg-emerald-100 hover:border-emerald-400',
    focus: 'focus:ring-emerald-300 focus:border-emerald-500',
    pending: 'border-amber-400 bg-amber-50 shadow-md ring-2 ring-amber-200',
  },
  entregaAdicional: {
    normal: 'border-amber-300 bg-white hover:bg-amber-50 hover:border-amber-400',
    focus: 'focus:ring-amber-300 focus:border-amber-500',
    pending: 'border-amber-400 bg-amber-50 shadow-md ring-2 ring-amber-200',
  },
} as const;
...
// Configuración de tarjetas de stock
